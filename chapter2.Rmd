...
## Question 3
Suppose vec is a vector of length 2. Interpreting vec as the coordinates ofa point in ($R^{2}$), 
use R to express it in polar coordinates. You will need (at least one of) the inverse trigonometric functions: 
